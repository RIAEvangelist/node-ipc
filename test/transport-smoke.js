...
function startFixture(name,file,socketRoot){
    ...
    const child=spawn(
        ...
        {
            cwd:projectRoot,
            env:{...process.env,NODE_IPC_TEST_SOCKET_ROOT:socketRoot},
...
function aggregateResults(results){
    ...
    const report=`transport smoke result: ${total-failureCount} passed, ${failureCount} failed, ${total} total`;
    console.log(`\n${report}`);
...
export {aggregateResults,run as default,run};
